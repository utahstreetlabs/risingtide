      ...
      module Nimbus
        ...
        class Processor
          ...
          def process_submitTopology(seqid, iprot, oprot)
            ...
            rescue Storm::AlreadyAliveException => e
              result.e = e
            rescue Storm::InvalidTopologyException => ite
              result.ite = ite
            end
          ...
          def process_killTopology(seqid, iprot, oprot)
            ...
            rescue Storm::NotAliveException => e
              result.e = e
            end
        ...
        class SubmitTopology_args
          ...
          FIELDS = {
            ...
            TOPOLOGY => {:type => ::Thrift::Types::STRUCT, :name => 'topology', :class => Storm::StormTopology}
          }
        ...
        class SubmitTopology_result
          ...
          FIELDS = {
            E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => Storm::AlreadyAliveException},
            ITE => {:type => ::Thrift::Types::STRUCT, :name => 'ite', :class => Storm::InvalidTopologyException}
          }
        ...
        class SubmitTopologyWithOpts_args
          ...
          FIELDS = {
            ...
            JSONCONF => {:type => ::Thrift::Types::STRING, :name => 'jsonConf'},
            TOPOLOGY => {:type => ::Thrift::Types::STRUCT, :name => 'topology', :class => Storm::StormTopology},
            OPTIONS => {:type => ::Thrift::Types::STRUCT, :name => 'options', :class => Storm::SubmitOptions}
          }
        ...
        class KillTopology_result
          ...
          FIELDS = {
            E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => Storm::NotAliveException}
          }
        ...
        class KillTopologyWithOpts_args
          ...
          FIELDS = {
            NAME => {:type => ::Thrift::Types::STRING, :name => 'name'},
            OPTIONS => {:type => ::Thrift::Types::STRUCT, :name => 'options', :class => Storm::KillOptions}
          }
        ...
        class Rebalance_args
          ...
          FIELDS = {
            NAME => {:type => ::Thrift::Types::STRING, :name => 'name'},
            OPTIONS => {:type => ::Thrift::Types::STRUCT, :name => 'options', :class => Storm::RebalanceOptions}
          }
        ...
        class GetClusterInfo_result
          ...
          FIELDS = {
            SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => Storm::ClusterSummary}
          }
        ...
        class GetTopologyInfo_result
          ...
          FIELDS = {
            SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => Storm::TopologyInfo},
            E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => Storm::NotAliveException}
          }
        ...
        class GetTopology_result
          ...
          FIELDS = {
            SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => Storm::StormTopology},
            E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => Storm::NotAliveException}
          }
